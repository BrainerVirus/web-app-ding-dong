...
function Home() {
  return (
    ...
    <div
      className={`${booststrap["container-fluid"]} ${homeStyle["flex-container"]} ${homeStyle["no-padding"]}`}
      id="home-nav-link"
    >
      <section
        id="titulo"
        className={`${homeStyle["header-section"]}  ${homeStyle["section-funciones-black"]}`}
      >
        <div className={`${homeStyle["custom-shape-divider-top-1656548389"]}`}>
          <svg
            data-name="Layer 1"
          ...
          >
            <path
              ...
              opacity=".25"
              className={`${homeStyle["shape-fill"]}`}
            ></path>
            <path
        ...
        <div className={`${homeStyle["divider"]}`}></div>
        <div
          className={`${homeStyle["custom-shape-divider-bottom-1656548343"]}`}
        >
          <svg
            data-name="Layer 1"
            xmlns="http://www.w3.org/2000/svg"
      ...
      <section
        className={`${homeStyle["flex-container"]} ${homeStyle["section-funciones-purple"]}`}
        id="funciones"
      >
        <div className={`${homeStyle["custom-shape-divider-top-1656548389"]}`}>
          <svg
        ...
        <div className={`${homeStyle["grid-container"]}`}>
          <h2 className={`${homeStyle["span-2"]}`}>Receptor</h2>
          <div className={`${homeStyle["flex-container"]}`}>
            <h4>Validación de identidad</h4>
            <i
              className={`${
                homeStyle["finger-print-icon"]
          ...
          <div className={`${homeStyle["flex-container"]}`}>
            ...
            <i className={`${homeStyle["bell-icon"]} ${"fa-solid fa-bell"}`} />
            <p>
          ...
          <div className={`${homeStyle["flex-container"]}`}>
            ...
            <i className={`${homeStyle["star-icon"]} ${"fa-solid fa-star"}`} />
      ...
      <section
        className={`${homeStyle["flex-container"]} ${homeStyle["section-funciones-black"]}`}
      >
        <div className={`${homeStyle["custom-shape-divider-top-1656548389"]}`}>
          <svg
            data-name="Layer 1"
        ...
        <div className={`${homeStyle["divider"]}`}></div>
        <div className={`${homeStyle["grid-container"]}`}>
          <h2 className={`${homeStyle["span-2"]}`}>Repartidor</h2>
          <div className={`${homeStyle["flex-container"]}`}>
            <h4>Validación de identidad</h4>
            <i
              className={`${
          ...
          <div className={`${homeStyle["flex-container"]}`}>
            ...
            <i
              className={`${homeStyle["routes-icon"]} ${"fa-solid fa-route"}`}
            />
          ...
          <div className={`${homeStyle["flex-container"]}`}>
            ...
            <i
              className={`${homeStyle["time-icon"]} ${"fa-solid fa-hourglass"}`}
            />
            <p>
          ...
          <div className={`${homeStyle["flex-container"]}`}>
            ...
            <i className={`${homeStyle["parcel-icon"]} ${"fa-solid fa-box"}`} />
            <p>
      ...
      >
        ...
        <div className={`${homeStyle["divider"]}`}></div>
        <div className={`${homeStyle["grid-container"]}`}>
          <h1 className={`${homeStyle["span-2"]}`}>Más información</h1>
          <p className={`${homeStyle["span-2"]}`}>
      ...
      >
        ...
        <div className={`${homeStyle["divider"]}`}></div>
        <div className={`${homeStyle["grid-container"]}`}>
          <h1 className={`${homeStyle["span-2"]}`}>Te interesa?</h1>
          <h2 className={`${homeStyle["span-2"]}`}>
            Contactanos para conocer más de a nuestro servicio!
          </h2>
          <form className={`${homeStyle["span-2"]}`}>
            <div className={`${"mb-3"}`}>
            ...
            <button
              type="submit"
              className={`${"btn btn-primary"} ${homeStyle["span-2"]} ${
                homeStyle["custom-btn-primary"]
              }`}
            >
              Enviar
            </button>
        ...
        <div className={`${homeStyle["divider"]}`}></div>
        <div
          className={`${homeStyle["custom-shape-divider-bottom-footer-1656548343"]}`}
        >
          <svg
            data-name="Layer 1"
            xmlns="http://www.w3.org/2000/svg"
        ...
        <a
          className={`${homeStyle["nav-item-base-status"]} ${"nav-link"}`}
          aria-current="page"
          href="#home-nav-link"
        >
          <i
            className={`${
              homeStyle["get-back-top"]
