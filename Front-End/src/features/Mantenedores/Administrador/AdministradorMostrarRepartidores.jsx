...
import "../../../scss/features/Administrador/MostrarRepartidoresAdminStyle.scss";
...
function AdministradorMostrarRepartidores() {
  ...
  return (
    <div className="container-fluid position-relative">
      <div className="row">
        <div className="col show-repartidores-table">
          <Link
            to="/cuenta/administrador/add/repartidor"
            className="btn btn-primary custom-btn-primary mt-2 mb-2"
          >
            Crear
          </Link>
                ...
                <tr key={account.id}>
                  ...
                  <td>
                    <Link
                      ...
                      className="btn btn-info custom-btn-primary me-2"
                    >
                      Editar
                    </Link>
                    <button
